...
export const zh = {
  ...
  'turnFold.duration': '耗时 {duration}',
  'turnFold.tools': '{tools} 个工具调用',
  'turnFold.thinks': '{thinks} 次思考',
  'turnFold.toggleOn': '思考折叠',
  'turnFold.toggleOff': '思考展开',
  'turnFold.ariaToggle': '展开或收起本回合的中间过程',
...
export const en = {
  ...
  'clock.md': '{m}/{d}',
  'clock.ymd': '{y}-{m}-{d}',
  'turnFold.duration': 'Time {duration}',
  'turnFold.tools': '{tools} tool calls',
  'turnFold.thinks': '{thinks} thinking',
  'turnFold.toggleOn': 'Thinking: folded',
  'turnFold.toggleOff': 'Thinking: shown',
  'turnFold.ariaToggle': 'Toggle turn folding',
